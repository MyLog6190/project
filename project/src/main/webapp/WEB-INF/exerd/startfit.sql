...
CREATE TABLE PROGRAM_EXERCISE(
	...
	P_SET VARCHAR2(10) NOT NULL,
	P_REPS VARCHAR2(10) NOT NULL,
	P_KG VARCHAR2(200) NOT NULL,
	P_REST VARCHAR2(100) NOT NULL
);	
...
-- PROGRAM INSERT
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E1','A','5','5','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E6','A','5','5','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E12','A','5','5','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E8','A','5','3','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E24','A','8','2','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E26','A','15','2','자유','90,180,300 택 1'
);

INSERT INTO PROGRAM_EXERCISE VALUES('P1','E1','B','5','5','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E16','B','5','5','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E3','B','1','5','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E14','B','5','3','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E22','B','8','2','자유','90,180,300 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E28','B','8','2','자유','90,180,300 택 1'
);


INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E1','A', '4', '10', '타겟 근육 컨트롤 가능한 무게', '120'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E6','A', '3', '10', '타겟 근육 컨트롤 가능한 무게', '90'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E14','A', '3', '실패 지점', '타겟 근육 컨트롤 가능한 무게', '90'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E17','A', '4', '10', '타겟 근육 컨트롤 가능한 무게', '90'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E22','A', '3', '10', '타겟 근육 컨트롤 가능한 무게', '90'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E26','A', '4', '실패 지점', '타겟 근육 컨트롤 가능한 무게', '90'
);




INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E10','A', '10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E14','A','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E9','A','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E11','A','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E1','B','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E5','B','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E28','B','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E16','C','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E22','C','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E18','C','10', '10', '20RM', '40,60,90 택 1'
);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E25','C','10', '10', '20RM', '40,60,90 택 1'
);
...
CREATE TABLE VOLUME(
	...
	DO_CHECK VARCHAR2(5) DEFAULT 'F' CHECK(DO_CHECK IN ('T', 'F'))
);
