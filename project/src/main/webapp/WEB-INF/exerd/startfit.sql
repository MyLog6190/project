...
delete from REGISTRATION_USER where user_id = 'tatelulove4@naver.com' 
...
SELECT V.R_NO AS R_NO, C_NAME, E_NO, E_NAME, E_IMG, V_NO, V_REPS, V_SET, V_KG, DO_CHECK
FROM  VOLUME V LEFT JOIN  PR R ON V.R_NO = R.R_NO
WHERE R_DATE = '2022-12-21';
