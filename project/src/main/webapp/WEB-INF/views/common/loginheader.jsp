...
<html>
    <head>     
        ...
        <meta name="keywords" content="Treetoper, startup, landing page, gradient background, image background,
         video background, template, responsive, bootstrap" />
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-6">
                        ...
                        <nav role="navigation" class="okayNav pull-right d-flex justify-content-end" id="js-navbar-menu">
                            <ul id="navbar-nav" class="navbar-nav d-flex flex-row justify-content-end flex-wrap">
                                <li><a class="btn-nav" href="#work">로그아웃</a></li>
